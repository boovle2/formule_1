    ...
    <div class="min-h-screen bg-zinc-800 py-12 px-4">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="text-center mb-8">
                <a href="{{ route('drivers.create') }}" class="inline-block bg-red-600 hover:bg-red-700 text-white font-bold py-3 px-8 rounded-lg transition duration-300 shadow-lg">
                    + Add New Driver
                </a>
            </div>
            @endif
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        ...
                        <div class="p-4 relative z-10">
                            ...
                            <div class="pt-4 border-t border-gray-700 space-y-2">
                                ...
                                <div class="flex gap-2">
                                    <a href="{{ route('drivers.edit', $driver->id) }}" class="flex-1 bg-blue-600 hover:bg-blue-700 text-white text-center font-semibold py-2 rounded-lg transition duration-300 text-xs">
                                        Edit
                                    </a>
                ...
                @empty
                    <div class="col-span-full text-center py-12">
                        <p class="text-gray-400 text-lg">No drivers found. <a href="{{ route('drivers.create') }}" class="text-red-500 hover:text-red-400">Add one now</a></p>
                    </div>
                @endforelse
            </div>
        </div>
