    ...
    <div class="min-h-screen bg-zinc-800 py-12 px-4">
        <div class="max-w-2xl mx-auto">
            <div class="bg-gray-800 rounded-xl shadow-lg p-8">
                <h1 class="text-4xl font-bold text-white mb-8">Create New Team</h1>
                ...
                <form action="{{ route('teams.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" name="team_principal" id="team_principal" value="{{ old('team_principal') }}"
                            class="w-full px-4 py-2 bg-gray-700 text-white border border-gray-600 rounded-lg focus:outline-none focus:border-red-600 focus:ring-1 focus:ring-red-600">
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" name="championships" id="championships" value="{{ old('championships') }}"
                            class="w-full px-4 py-2 bg-gray-700 text-white border border-gray-600 rounded-lg focus:outline-none focus:border-red-600 focus:ring-1 focus:ring-red-600">
                    </div>
                    ...
                    <div class="mb-8">
                        ...
                        <input type="file" name="logo" id="logo" accept="image/*"
                            class="w-full px-4 py-2 bg-gray-700 text-white border border-gray-600 rounded-lg focus:outline-none focus:border-red-600 focus:ring-1 focus:ring-red-600">
                        <p class="text-gray-400 text-sm mt-2">Upload a team logo image</p>
                    </div>
                    ...
                    <div class="flex gap-4">
                        ...
                        <a href="{{ route('teams.index') }}" class="flex-1 bg-gray-700 hover:bg-gray-600 text-white font-bold py-3 rounded-lg transition duration-300 text-center">
                            Cancel
                        </a>
                    </div>
                </form>
